...
{
    public class RepositorioLeituraBase<TEntidade> : RepCon<TEntidade>, IRepositorioLeituraBase<TEntidade> where TEntidade : Identificador
    {
        #region ctor
        public RepositorioLeituraBase(Contexto contexto)
            : base(contexto)
        {
        }
        #endregion
